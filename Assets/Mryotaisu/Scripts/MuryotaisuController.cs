            ...
            if (controller.isGrounded)
            {
                ...
                if (Input.GetKey("up") || Input.GetKey("w"))
                {
                    ...
                    } else if (angleDiff > 1f)
                    {
                        ...
                        // Only set Y rotation, preserve X and Z
                        Vector3 currentEuler = transform.localEulerAngles;
                        transform.localEulerAngles = new Vector3(currentEuler.x, 180, currentEuler.z);
                    }
                }
                ...
                if (Input.GetKey("right") || Input.GetKey("d"))
                {
                    ...
                    } else 
                    {
                        // Only set Y rotation, preserve X and Z
                        Vector3 currentEuler = transform.localEulerAngles;
                        transform.localEulerAngles = new Vector3(currentEuler.x, -90, currentEuler.z);
                    }
                }
                ...
                if (Input.GetKey("down") || Input.GetKey("s")) 
                {
                    ...
                    {
                        // Only set Y rotation to 0, preserve X and Z
                        Vector3 currentEuler = transform.localEulerAngles;
                        transform.localEulerAngles = new Vector3(currentEuler.x, 0, currentEuler.z);
                    }
                }
